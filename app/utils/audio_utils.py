...
def normalize_audio_loudness(
    ...
    try:
        ...
        cmd = [
            ...
            "-i", input_path,
            "-probesize", "50M",  # Increase probe size for better loudness analysis
            "-af", f"loudnorm=I={target_loudness}:TP={true_peak}:LRA={loudness_range}:print_format=summary",
            "-ar", "48000",  # Standard sample rate for video production
            temp_output
        ]
