...
def update_env_file(credentials):
    ...
    if 'installed' in credentials:
        ...
        set_key(env_path, 'YOUTUBE_CLIENT_SECRET', credentials['installed']['client_secret'])
    else:
        # Custom format
...
def main():
    ...
    try:
        ...
        response = input("Would you like to delete the credentials file from Downloads? (y/N): ")
        if response.lower() == 'y':
