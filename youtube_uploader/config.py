...
class YouTubeConfig:
    ...
    def from_env(cls) -> 'YouTubeConfig':
        ...
        return cls(
            ...
            default_description=os.getenv('YOUTUBE_DEFAULT_DESCRIPTION', cls.default_description),
            default_tags=os.getenv('YOUTUBE_DEFAULT_TAGS', '').split(',') if os.getenv('YOUTUBE_DEFAULT_TAGS') else None,
            default_category=os.getenv('YOUTUBE_DEFAULT_CATEGORY', cls.default_category),
    ...
    def validate(self) -> bool:
        ...
        client_secret_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), '.files', 'client_secret.json')
