...
class OutputManager:
    ...
    def get_path(self, filename, subdir=None):
        ...
        if not self.current_run_dir:
            raise ValueError("No run directory created yet. Call create_run_directory() first.")
...
def get_output_paths(dirs, timestamp):
    ...
    return {
        ...
        'video_with_captions': os.path.join(dirs['video'], f'video_with_captions_{timestamp}.mp4'),
